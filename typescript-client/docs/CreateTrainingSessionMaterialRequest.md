...
```typescript
import type { CreateTrainingSessionMaterialRequest } from ''
...
const example = {
  ...
  "sort_order": null,
} satisfies CreateTrainingSessionMaterialRequest
...
const exampleParsed = JSON.parse(exampleJSON) as CreateTrainingSessionMaterialRequest
